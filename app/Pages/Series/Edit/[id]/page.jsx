                ...
                <form onSubmit={handleSubmit} className="flex flex-col justify-center items-center">
                    <div>
                        <input
                            ...
                            name='name'
                            value={postData.name}
                            className="w-[640px] block bg-gray-200 border py-1 rounded text-lg my-2 text-center drop-shadow-md"
                        />
                    </div>
                    <div>
                        <input
                    ...
                    <button type='submit' className="w-[290px] block bg-gray-400 py-2 rounded font-bold text-xl text-white my-2 text-center mt-9 hover:rounded-3xl hover:bg-black">
                        Update Series
                    </button>
                </form>
            </div>
