  ...
  return (
    <main>
        <div className="w-full flex flex-col justify-center items-center z-0">
            <div className="w-9/12 flex flex-col justify-center items-center mt-32">
                <span className="text-3xl font-bold mb-16">
                    Series
                </span>
            </div>
            <div className="flex flex-col justify-center items-center mt-16">
                <div className="w-9/12 flex justify-end items-center mb-9">
                    <Link href='/Pages/Series/Create'>
                        <span className="py-2 px-4 font-bold text-xl text-white bg-black rounded hover:rounded-3xl"> 
                            Add New Series
                        </span>
                    </Link>
                </div>
                <div className="w-9/12 flex flex-row flex-wrap justify-center items-center gap-8 mb-20">
                            ...
                            <div key={val._id}>
                                <div className="group flex flex-col overflow-hidden cursor-pointer rounded-lg border-2 border-white hover:border-gray-400">
                                    ...
                                    <div className="flex justify-end mt-3 p-2">
                                        <Link className="bg-gray-400 text-white border py-1 px-2 m-1 rounded-md text-lg hover:bg-black hover:rounded-2xl" href={`/Pages/Series/Edit/${val._id}`}>Edit</Link>
